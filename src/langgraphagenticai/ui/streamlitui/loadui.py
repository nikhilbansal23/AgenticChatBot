...
class LoadStreamlitUI:
    ...
    def load_streamlit_ui(self):
        ...
        with st.sidebar:
            ...
            if self.user_controls["selected_usecase"] == "Chatbot with Internet" or self.user_controls["selected_usecase"] == "AI News":
                os.environ["TAVILY_API_KEY"]=self.user_controls["TAVILY_API_KEY"]=st.session_state["TAVILY_API_KEY"]=st.text_input("TAVILY API KEY",type="password")
                if not self.user_controls["TAVILY_API_KEY"]:
                    st.warning("⚠️ Please enter your Tavily API key to proceed. Don't have? refer : https://tavily.com/home ")
